...
# Roboter 4 aktiviert!
# Roboter 5 aktiviert!
for roboter in range(1, 6):
    print(f"Roboter {roboter} aktiviert!")
...
# 4. Gib nach jedem Treffer die restlichen Lebenspunkte aus.
    print(f"Treffer! Bugzilla hat noch {leben} Lebenspunkte!")

# 5. Wenn der Boss besiegt ist, soll erscheinen: Bugzilla wurde besiegt!
print("Bugzilla wurde besiegt!")
